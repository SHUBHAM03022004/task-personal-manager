            ...
            <div class="card">
                ...
                <div class="card-body">
                    <table class="table table-striped" id="table1">
                        ...
                        <tbody>
                           <?php $__currentLoopData = $usersdata; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td><?php echo e($value->id); ?></td>
                                <td><?php echo e($value->name); ?></td>
                                <td class="text-center"><?php echo e($value->email); ?></td>
                                <!-- <td class="text-center">
                                    <button type="button" onclick="getDatafromDB('<?php echo e($value->id); ?>')" data-id="<?php echo e($value->id); ?>" class="btn btn-success" data-toggle="modal" data-target="#exampleModal2">
                                      Edit
                                    </button>
                                    <button type="button" onclick="DeleteDatafromDB('<?php echo e($value->id); ?>')" data-id="<?php echo e($value->id); ?>" class="btn btn-danger">
                                        Delete</button>
                                    <a href="/works/<?php echo e($value->id); ?>"><button class="btn btn-info">Details</button></a>
                                </td> -->
                            </tr>
...
</script><?php /**PATH C:\Users\ASUS\Downloads\personal_task_manager-main\resources\views/users.blade.php ENDPATH**/ ?>