                        ...
                        <tbody>
                           <?php $__currentLoopData = $myworkdata; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td><?php echo e($value->id_work); ?></td>
                                <td><?php echo e($value->title); ?></td>
                                <td class="text-center"><?php echo e($value->subject); ?></td>
                                <td class="text-center"><?php echo e($value->desc); ?></td>
                                ...
                                <td class="text-center">
                                    <button type="button" onclick="getDatafromDB('<?php echo e($value->id_work); ?>')" data-id="<?php echo e($value->id_work); ?>" class="btn btn-success" data-toggle="modal" data-target="#exampleModal2">
                                      Edit
                                    </button>
                                    <button type="button" onclick="DeleteDatafromDB('<?php echo e($value->id_work); ?>')" data-id="<?php echo e($value->id_work); ?>" class="btn btn-danger">
                                        Delete</button>
                                    <a href="/works/<?php echo e($value->id_work); ?>"><button class="btn btn-info">Details</button></a>
                                </td>
                            </tr>
...
</script><?php /**PATH C:\Users\ASUS\Downloads\personal_task_manager-main\resources\views/works.blade.php ENDPATH**/ ?>