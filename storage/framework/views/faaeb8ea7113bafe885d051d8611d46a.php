            ...
            <div class="card">
                ...
                <div class="card-body">
                    <table class="table table-striped" id="table1">
                        ...
                        <tbody>
                           <?php $__currentLoopData = $projectdata; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td><?php echo e($value->id_proj); ?></td>
                                <td><?php echo e($value->title_proj); ?></td>
                                <td class="text-center"><?php echo e($value->subject_proj); ?></td>
                                <td class="text-center"><?php echo e($value->language_proj); ?></td>
                                <td class="text-center"><?php echo e($value->desc_proj); ?></td>
                                <td class="text-center">
                                    <?php if($value->status_proj == '1'): ?>
                                        <span class="badge bg-success">Active</span>
                                    <?php elseif($value->status_proj == '2'): ?>
                                ...
                                <td class="text-center">
                                    <button type="button" onclick="getDatafromDB('<?php echo e($value->id_proj); ?>')" data-id="<?php echo e($value->id_proj); ?>" class="btn btn-success" data-toggle="modal" data-target="#exampleModal2">
                                      Edit
                                    </button>
                                    <button type="button" onclick="DeleteDatafromDB('<?php echo e($value->id_proj); ?>')" data-id="<?php echo e($value->id_proj); ?>" class="btn btn-danger">
                                        Delete</button>
                                    <a href="/projects/<?php echo e($value->id_proj); ?>"><button class="btn btn-info">Details</button></a>
                                </td>
                            </tr>
...
</script><?php /**PATH C:\Users\ASUS\Downloads\personal_task_manager-main\resources\views/projects.blade.php ENDPATH**/ ?>