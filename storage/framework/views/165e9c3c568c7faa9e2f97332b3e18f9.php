...
<head>
    ...
    <link rel="shortcut icon" href="<?php echo e(asset('assets/images/fvcon.png')); ?>" type="image/x-icon">
                ...
                <div class="sidebar-header">
                    <div class="d-flex justify-content-between">
                        <div class="logo">
                            <!-- <h5>Note Diary</h5>
                            <h6>My Life Works</h6> -->
                            <a href="index.html"><img src="<?php echo e(asset('assets/images/logo.png')); ?>" alt="Logo" srcset="" style="width:200px;height:50px"></a>
                        </div>
                        <div class="toggler">
...
<?php /**PATH C:\Users\ASUS\Downloads\personal_task_manager-main\resources\views/header.blade.php ENDPATH**/ ?>