            ...
            <div class="card">
                ...
                <div class="card-body">
                    <table class="table table-striped" id="table1">
                        ...
                        <tbody>
                           <?php $__currentLoopData = $myaccountsdata; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td><?php echo e($value->id_sac); ?></td>
                                <td><?php echo e($value->title_sac); ?></td>
                                <td class="text-center"><?php echo e($value->email_sac); ?></td>
                                <td class="text-center"><a target="__blank" href="<?php echo e($value->link_sac); ?>"><?php echo e($value->link_sac); ?></a></td>
                                <td class="text-center">
                                    <button type="button" onclick="getDatafromDB('<?php echo e($value->id_sac); ?>')" data-id="<?php echo e($value->id_sac); ?>" style="background:none;border:none" data-toggle="modal" data-target="#exampleModal2">
                                    <?php if($value->status_sac == '1'): ?>
                                        <span class="badge bg-primary">Active</span>
                                        <?php elseif($value->status_sac == '2'): ?>
                                        <span class="badge bg-warning">Slow Down</span>                                
                                        <?php elseif($value->status_sac == '3'): ?>
                                        <span class="badge bg-success">Updated</span>                                
                                    <?php else: ?>
                                        <span class="badge bg-danger">Deactive</span>                                
                                    <?php endif; ?>
                                    </button>
                                <!--    <button type="button" onclick="DeleteDatafromDB('<?php echo e($value->id_sac); ?>')" data-id="<?php echo e($value->id_sac); ?>" class="btn btn-danger">
                                        Delete</button> 
                                    <a href="/works/<?php echo e($value->id_sac); ?>"><button class="btn btn-info">Details</button></a>-->
                                </td> 
                            </tr>
...
</script><?php /**PATH C:\Users\ASUS\Downloads\personal_task_manager-main\resources\views/accounts.blade.php ENDPATH**/ ?>